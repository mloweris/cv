...
\familyname{Mark Lowerison, Msc.} % Your last name

% All information in this block is optional, comment out any lines you don't need
\title{Curriculum Vitae}
%\address{3330 Hospital Drive NW}{Calgary, Alberta T2N 4N1}
\mobile{(403) 608 5157}
\phone{(403) 210 6375}
\fax{(403) 210 9982}
\email{mwloweri@ucalgary.ca}
\homepage{cru.uclagary.ca}{cru.ucalgary.ca} % The first argument is the url for the clickable link, the second argument is the url displayed in the template - this allows special characters to be displayed such as the tilde in this example
%\extrainfo{Room B152, Health Sciences Centre, University of Calgary}
...
\cventry{2004--2008}{Masters of Science}{The University of Guelph}{Guelph, ON}{\textit{GPA -- 3.7}}{Honours}  % Arguments not required can be left empty
\cventry{1997--2001}{Bachelor of Science}{Dalhousie University}{Truro, NS}{\textit{GPA -- 3.3}}{Specialized in Animal Science}

\section{Masters Thesis}

\cvitem{Title}{\emph{Prediction of Dry Matter Intake in Beef Bulls}}
\cvitem{Supervisors}{Professor James Wilton \& Professor Stephen Miller}
\cvitem{Description}{This thesis explored the application of production and biological systems modeling to prediction of dry matter intake in beef bulls.}
